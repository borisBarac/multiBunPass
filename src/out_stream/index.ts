import type { ExecResult, OutputWrapperOptions, OutputWrapperStatus } from "../types";
...
export class OutputWrapper {
  ...
  async spawnAndWrap(
    ...
    await Promise.all([
      pipeStream(proc.stdout as ReadableStream<Uint8Array> | undefined, stdoutChunks),
      pipeStream(proc.stderr as ReadableStream<Uint8Array> | undefined, stderrChunks),
    ]);
